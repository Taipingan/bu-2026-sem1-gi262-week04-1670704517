...
namespace Assignment
{
    public class Assignment : MonoBehaviour
    {
        ...
        public void AS03_CheckValidBrackets()
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                         ...
                         current == '}')
                {
                    ...
                    char opening = stack.Last.Value;

                    if (brackets[opening] != current)
                    {
                        valid = false;
                        break;
                    }
        ...
        public void AS05_FindMiddleElement()
        {
            ...
            LinkedListNode<string> slow =
                list.First;

            LinkedListNode<string> fast =
                list.First;
        ...
        public void AS08_TopFrequentNumber()
        {
            ...
            int maxCount = numberCount[mostFrequent];
            ...
            Debug.Log(mostFrequent + " count: " + maxCount);
        }
